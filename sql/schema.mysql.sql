...
CREATE TABLE IF NOT EXISTS sites (
  ...
  monitor_type             ENUM('active','heartbeat') NOT NULL DEFAULT 'active',
  method                   VARCHAR(10) NOT NULL DEFAULT 'GET',
  interval_seconds         INT UNSIGNED NOT NULL DEFAULT 60,
  timeout_ms               INT UNSIGNED NOT NULL DEFAULT 10000,
  check_type               ENUM('status','string','json') NULL DEFAULT 'status',
...
CREATE TABLE IF NOT EXISTS channels (
  id          INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  name        VARCHAR(120) NOT NULL,
  type        ENUM('discord','webhook','email') NOT NULL,
